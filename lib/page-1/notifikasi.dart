        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              padding: EdgeInsets.fromLTRB(0*fem, 3*fem, 0*fem, 10*fem),
              width: double.infinity,
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                    ...
                    child: RichText(
                      text: TextSpan(
                        ...
                        children: [
                          ...
                          TextSpan(
                            text: 'Pinjaman yang anda ajukan sudah didanai secara penuh, dana telah dipindahkan ke saldo anda.\n',
                            style: SafeGoogleFont (
                              'Poppins',
                              fontSize: 10*ffem,
                    ...
                    child: RichText(
                      text: TextSpan(
                        ...
                        children: [
                          ...
                          TextSpan(
                            text: 'Pinjaman sukses diajukan, dana akan dikirimkan ke saldo anda setelah dana terkumpul atau dalam kurun waktu 3 bulan.\n',
                            style: SafeGoogleFont (
                              'Poppins',
                              fontSize: 10*ffem,
                              fontWeight: FontWeight.w400,
                    ...
                    child: RichText(
                      text: TextSpan(
                        ...
                        children: [
                          ...
                          TextSpan(
                            text: 'Tagihan anda untuk pinjaman No P112020220 belum dibayarkan, harap lakukan pembayaran segera.\n',
                            style: SafeGoogleFont (
                              'Poppins',
                              fontSize: 10*ffem,
                              fontWeight: FontWeight.w400,

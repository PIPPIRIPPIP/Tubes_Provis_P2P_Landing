        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              margin: EdgeInsets.fromLTRB(15*fem, 0*fem, 18*fem, 20*fem),
              width: double.infinity,
              height: 45*fem,
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    height: 45*fem,
                    child: Image.asset(
                      'assets/page-1/images/moneylogodesignstemplatevectorfinancelogodesignsvector1-removebg-preview-1-EYW.png',
                    ),
                  ),
                  Container(
            ...
            Container(
              ...
              padding: EdgeInsets.fromLTRB(15*fem, 5*fem, 17*fem, 9*fem),
              width: double.infinity,
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          margin: EdgeInsets.fromLTRB(15*fem, 0*fem, 24*fem, 20*fem),
                          width: double.infinity,
                          child: Row(
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: [
                        ...
                        children: [
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                Container(
                                  // igaminghouseJr2 (63:616)
                                  margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 1*fem, 3.07*fem),
                                  width: 26.87*fem,
                                  height: 23.52*fem,
                                  child: Image.asset(
                                    'assets/page-1/images/i-gaming-house-nnr.png',
                                    width: 26.87*fem,
                                    height: 23.52*fem,
                                  ),
                                ),
                          ...
                          Container(
                            // autogroupa23z9re (3w9ik4pVGVbG9nnjMoA23Z)
                            ...
                            child: Column(
                              ...
                              children: [
                                Container(
                                  ...
                                  height: 27.5*fem,
                                  child: Image.asset(
                                    'assets/page-1/images/receive-THG.png',
                                    width: 29.77*fem,
                                    height: 27.5*fem,
                                  ),
                                ),
                          ...
                          Container(
                            // autogroupw9ts8Tg (3w9ir9UgyzW6Tvo3kWw9ts)
                            ...
                            child: Column(
                              ...
                              children: [
                                Container(
                                  ...
                                  height: 23.83*fem,
                                  child: Image.asset(
                                    'assets/page-1/images/icon-PaN.png',
                                    width: 23.83*fem,
                                    height: 23.83*fem,
                                  ),
                                ),
                                Text(
                                  // tagihanpinjamanZot (63:622)
                                  'Tagihan & Pinjaman',
                                  textAlign: TextAlign.center,
                                  style: SafeGoogleFont (
                                    'Poppins',

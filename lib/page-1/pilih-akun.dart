            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  margin:
                      EdgeInsets.fromLTRB(0 * fem, 0 * fem, 2 * fem, 21 * fem),
                  child: Text(
                    'Pilih Jenis Akun',
                ...
                Container(
                  ...
                  margin:
                      EdgeInsets.fromLTRB(0 * fem, 0 * fem, 1 * fem, 31 * fem),
                      ...
                      TextButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => DaftarInvestor()));
                        },
                      ...
                      TextButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => DaftarPerorangan()));
                        },
                        style: TextButton.styleFrom(
                          padding: EdgeInsets.zero,
                        ),

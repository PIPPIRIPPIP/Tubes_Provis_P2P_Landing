...
class DetailMitra extends StatelessWidget {
                        ...
                        child: Column(
                            ...
                            children: [
                                  ...
                                  child: Padding(
                                      ...
                                      child: Row(children: [
                                        ...
                                        Padding(
                                            ...
                                            child: Text("${user.pinjaman?.tenor.toString() ?? "0"} Bulan",
                                                overflow: TextOverflow.ellipsis,
                                                textAlign: TextAlign.left,
                                                style: AppStyle
                                                    .txtPoppinsMedium15Black90001))
                              ...
                              Align(
                                  ...
                                  child: Padding(
                                      padding: getPadding(
                                          left: 43, top: 7, right: 72),
                                      child: Row(children: [
                                        Padding(
                                            padding: getPadding(top: 4),
                                            child: Text("Tentang Mitra",
                                                overflow: TextOverflow.ellipsis,
                                                textAlign: TextAlign.left,
                                                style: AppStyle
                                  ...
                                  child: Row(
                                      ...
                                      children: [
                                        ...
                                        Container(
                                            ...
                                            child: Text(
                                                "${user.pinjaman?.tenor.toString() ?? "0"} Bulan\n${user.pinjaman?.bunga.toString() ?? "0"}%\n${user.pinjaman?.jenisAngsuran.toString() ?? "-"}\nRp ${user.pinjaman?.jumlahAngsuran.toString() ?? "0"}\nRp ${user.pendapatan.toString()}\n${user.pinjaman?.tujuanPinjaman.toString() ?? "-"} ",
                                                maxLines: null,
  ...
  // onTapDetailmitra(BuildContext context) {
